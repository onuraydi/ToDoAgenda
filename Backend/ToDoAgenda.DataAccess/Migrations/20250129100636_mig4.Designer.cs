            ...
            modelBuilder.Entity("TODoAgenda.Entities.Concrete.Task", b =>
                {
                    b.HasOne("TODoAgenda.Entities.Concrete.ImportanceLevel", "ImportanceLevel")
                        .WithOne("Task")
                        .HasForeignKey("TODoAgenda.Entities.Concrete.Task", "ImportanceLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TODoAgenda.Entities.Concrete.Result", "Result")
                        .WithOne("Task")
                        .HasForeignKey("TODoAgenda.Entities.Concrete.Task", "ResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TODoAgenda.Entities.Concrete.Timer", "Timer")
                        .WithOne("Task")
                        .HasForeignKey("TODoAgenda.Entities.Concrete.Task", "TimerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
